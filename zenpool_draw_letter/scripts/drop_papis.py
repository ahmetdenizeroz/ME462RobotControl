...
class DropPapisNode(Node):
    def __init__(self):
        super().__init__('drop_papis_node')
    ...
    def run_sequence(self):
        self.get_logger().info("Starting Drop Papis Sequence...")
        
        self.get_logger().info("Move 1 (Joint Space)")
        self.move_joints([1.350012, -1.498335, -1.527674, -1.686037, -1.570700, 2.576514])
        
        self.get_logger().info("Move 2: Cartesian Pool Frame [-0.459, -0.133, 0.231]")
        self.execute_absolute_cartesian('pool_actual', -0.459, -0.133, 0.231)
        
        self.get_logger().info("Move 3: Cartesian Pool Frame [-0.759, -0.133, 0.231]")
        self.execute_absolute_cartesian('pool_actual', -0.759, -0.133, 0.231)
        
        self.get_logger().info("Move 4: Cartesian Pool Frame [-0.759, -0.133, 0.111]")
        self.execute_absolute_cartesian('pool_actual', -0.759, -0.133, 0.111)
        
        self.get_logger().info("Move 5: Cartesian Pool Frame [-0.459, -0.133, 0.111]")
        self.execute_absolute_cartesian('pool_actual', -0.459, -0.133, 0.111)
        
        self.get_logger().info("Move 6 (Joint Space)")
        self.move_joints([-0.088989, -1.564788, -1.975573, -1.171986, 1.570731, 2.267174])
        
        self.get_logger().info("====================================")
        self.get_logger().info("    DROP PAPIS SEQUENCE COMPLETE!   ")
        self.get_logger().info("====================================")
